...
public:
    ...
    virtual void SetTorqueLimitMode(DynamicsConstraints torquelimitmode);
...
protected:
    ...
    int _filtermask;
    DynamicsConstraints _torquelimitmode; ///< 1 if should use instantaneous max torque, 0 if should use nominal torque
    dReal _perturbation;
