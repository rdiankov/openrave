...
enum OpenRAVEErrorCode {
    ...
    ORE_CurlTimeout=16, ///< curl download timed out
    ORE_CurlInvalidHandle=17, ///< the curl handle cannot be created
    ORE_CurlInvalidResponse=18, ///< curl downloaded response is invalid
};
