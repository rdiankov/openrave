...
typedef tools::shared_ptr<ConstraintFilterReturn> ConstraintFilterReturnPtr;
...
public:
    ...
    typedef tools::shared_ptr< PlannerBase::ConfigurationList > ConfigurationListPtr;
    typedef std::list< std::pair< std::vector<dReal>, std::vector<dReal> > > ConfigurationVelocityList;
    typedef tools::shared_ptr< PlannerBase::ConfigurationVelocityList > ConfigurationVelocityListPtr;
...
public:
        ...
        {
public:
            StateSaver(tools::shared_ptr<PlannerParameters> params);
            virtual ~StateSaver();
            inline tools::shared_ptr<PlannerParameters> GetParameters() const {
                return _params;
            }
            virtual void Restore();
protected:
            tools::shared_ptr<PlannerParameters> _params;
            std::vector<dReal> _values;
private:
            virtual void _Restore();
        };

        typedef tools::shared_ptr<StateSaver> StateSaverPtr;
        ...
        virtual void copy(tools::shared_ptr<PlannerParameters const> r);
...
protected:
        ...
        inline tools::shared_ptr<PlannerBase::PlannerParameters> shared_parameters() {
            return tools::static_pointer_cast<PlannerBase::PlannerParameters>(shared_from_this());
        }
        inline tools::shared_ptr<PlannerBase::PlannerParameters const > shared_parameters_const() const {
            return tools::static_pointer_cast<PlannerBase::PlannerParameters const>(shared_from_this());
        }
        ...
        tools::shared_ptr<std::stringstream> _sslocal;
...
private:
    ...
    typedef tools::shared_ptr<PlannerBase::PlannerParameters> PlannerParametersPtr;
    typedef tools::shared_ptr<PlannerBase::PlannerParameters const> PlannerParametersConstPtr;
    typedef tools::weak_ptr<PlannerBase::PlannerParameters> PlannerParametersWeakPtr;
    typedef tools::weak_ptr<PlannerBase::PlannerParameters const> PlannerParametersWeakConstPtr;
...
public:
    ...
    /// \deprecated (11/10/03)
    virtual PlannerStatus PlanPath(TrajectoryBasePtr traj, tools::shared_ptr<std::ostream> pOutStream) RAVE_DEPRECATED {
        if( !!pOutStream ) {
...
protected:
    inline PlannerBasePtr shared_planner() {
        return tools::static_pointer_cast<PlannerBase>(shared_from_this());
    }
    inline PlannerBaseConstPtr shared_planner_const() const {
        return tools::static_pointer_cast<PlannerBase const>(shared_from_this());
    }
