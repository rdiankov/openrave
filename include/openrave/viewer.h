...
typedef tools::shared_ptr<GraphHandle> GraphHandlePtr;
typedef tools::shared_ptr<GraphHandle const> GraphHandleConstPtr;
typedef tools::weak_ptr<GraphHandle const> GraphHandleWeakPtr;
...
protected:
    ...
    inline ViewerBasePtr shared_viewer() {
        return tools::static_pointer_cast<ViewerBase>(shared_from_this());
    }
    inline ViewerBaseConstPtr shared_viewer_const() const {
        return tools::static_pointer_cast<ViewerBase const>(shared_from_this());
    }
