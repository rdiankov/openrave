...
typedef tools::shared_ptr<StringXMLReadable> StringXMLReadablePtr;
...
public:
    ...
    std::list<tools::shared_ptr<HierarchicalXMLReadable> > _listchildren;
};

typedef tools::shared_ptr<HierarchicalXMLReadable> HierarchicalXMLReadablePtr;
...
typedef tools::shared_ptr<TrajectoryReader> TrajectoryReaderPtr;
...
typedef tools::shared_ptr<GeometryInfoReader> GeometryInfoReaderPtr;
...
typedef tools::shared_ptr<ElectricMotorActuatorInfoReader> ElectricMotorActuatorInfoReaderPtr;
...
private:
    std::string _xmlid;
    tools::shared_ptr<HierarchicalXMLReader> _pcurreader;
    HierarchicalXMLReadablePtr _readable;
};

typedef tools::shared_ptr<HierarchicalXMLReader> HierarchicalXMLReaderPtr;
...
public:
    ...
    std::list<tools::shared_ptr<StreamXMLWriter> > _listchildren;
    std::string _xmltag, _data;
    AttributesList _atts;
};

typedef tools::shared_ptr<StreamXMLWriter> StreamXMLWriterPtr;
