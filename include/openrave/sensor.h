...
public:
    ...
    typedef tools::shared_ptr<SensorBase::SensorData> SensorDataPtr;
    typedef tools::shared_ptr<SensorBase::SensorData const> SensorDataConstPtr;
...
public:
    ...
    typedef tools::shared_ptr<SensorBase::SensorGeometry> SensorGeometryPtr;
    typedef tools::shared_ptr<SensorBase::SensorGeometry const> SensorGeometryConstPtr;
...
public:
    ...
    typedef tools::shared_ptr<LaserGeomData> LaserGeomDataPtr;
    typedef tools::shared_ptr<LaserGeomData const> LaserGeomDataConstPtr;
...
public:
    ...
    typedef tools::shared_ptr<CameraGeomData> CameraGeomDataPtr;
    typedef tools::shared_ptr<CameraGeomData const> CameraGeomDataConstPtr;
