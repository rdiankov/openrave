...
typedef tools::shared_ptr< OpenRAVEFunctionParserReal > OpenRAVEFunctionParserRealPtr;
...
typedef tools::shared_ptr<ElectricMotorActuatorInfo> ElectricMotorActuatorInfoPtr;
...
public:
    ...
    typedef tools::shared_ptr<GeometryInfo> GeometryInfoPtr;
    typedef tools::shared_ptr<GeometryInfo const> GeometryInfoConstPtr;
...
public:
    ...
    typedef tools::shared_ptr<LinkInfo> LinkInfoPtr;
    typedef tools::shared_ptr<LinkInfo const> LinkInfoConstPtr;

    /// \brief A rigid body holding all its collision and rendering data.
    class OPENRAVE_API Link : public tools::enable_shared_from_this<Link>
    {
public:
        ...
        typedef tools::shared_ptr<KinBody::GeometryInfo> GeometryInfoPtr RAVE_DEPRECATED;
...
public:
            ...
            Geometry(tools::shared_ptr<Link> parent, const KinBody::GeometryInfo& info);
            virtual ~Geometry() {
            }
...
protected:
        ...
        typedef tools::shared_ptr<Geometry> GeometryPtr;
        typedef tools::shared_ptr<Geometry const> GeometryConstPtr;
        ...
        virtual void GetParentLinks(std::vector< tools::shared_ptr<Link> >& vParentLinks) const;

        /// \brief Tests if a link is a direct parent.
        ///
        /// \see GetParentLinks
        /// \param link The link to test if it is one of the parents of this link.
        virtual bool IsParentLink(tools::shared_ptr<Link const> plink) const;
        ...
        virtual void SwapGeometries(tools::shared_ptr<Link>& link);
        ...
        virtual bool IsRigidlyAttached(tools::shared_ptr<Link const> plink) const;
        ...
        virtual void GetRigidlyAttachedLinks(std::vector<tools::shared_ptr<Link> >& vattachedlinks) const;
...
private:
    ...
    typedef tools::shared_ptr<KinBody::Link> LinkPtr;
    typedef tools::shared_ptr<KinBody::Link const> LinkConstPtr;
    typedef tools::weak_ptr<KinBody::Link> LinkWeakPtr;
...
public:
    ...
    typedef tools::shared_ptr<MimicInfo> MimicInfoPtr;
    typedef tools::shared_ptr<MimicInfo const> MimicInfoConstPtr;
...
public:
        ...
        struct DOFFormat
        {
            ...
            bool operator ==(const DOFFormat& r) const;
            tools::shared_ptr<Joint> GetJoint(KinBodyPtr parent) const;
            tools::shared_ptr<Joint const> GetJoint(KinBodyConstPtr parent) const;
        };
        struct DOFHierarchy
        {
    ...
    typedef tools::shared_ptr<Mimic> MimicPtr;
    typedef tools::shared_ptr<Mimic const> MimicConstPtr;
...
public:
    ...
    typedef tools::shared_ptr<JointInfo> JointInfoPtr;
    typedef tools::shared_ptr<JointInfo const> JointInfoConstPtr;

    /// \brief Information about a joint that controls the relationship between two links.
    class OPENRAVE_API Joint : public tools::enable_shared_from_this<Joint>
    {
public:
        /// \deprecated 12/10/19
...
private:
    ...
    typedef tools::shared_ptr<KinBody::Joint> JointPtr;
    typedef tools::shared_ptr<KinBody::Joint const> JointConstPtr;
    typedef tools::weak_ptr<KinBody::Joint> JointWeakPtr;
...
public:
    ...
    typedef tools::shared_ptr<KinBody::BodyState> BodyStatePtr;
    typedef tools::shared_ptr<KinBody::BodyState const> BodyStateConstPtr;

    /// \brief Access point of the sensor system that manages the body.
    class OPENRAVE_API ManageData : public tools::enable_shared_from_this<ManageData>
    {
public:
...
private:
    ...
    typedef tools::shared_ptr<KinBody::ManageData> ManageDataPtr;
    typedef tools::shared_ptr<KinBody::ManageData const> ManageDataConstPtr;
...
public:
        ...
        virtual void Restore(tools::shared_ptr<KinBody> body=tools::shared_ptr<KinBody>());
...
private:
        virtual void _RestoreKinBody(tools::shared_ptr<KinBody> body);
    };

    typedef tools::shared_ptr<KinBodyStateSaver> KinBodyStateSaverPtr;
    ...
    typedef tools::shared_ptr<AccelerationMap> AccelerationMapPtr;
    typedef tools::shared_ptr<AccelerationMap const> AccelerationMapConstPtr;
...
protected:
    ...
    inline KinBodyPtr shared_kinbody() {
        return tools::static_pointer_cast<KinBody>(shared_from_this());
    }
    inline KinBodyConstPtr shared_kinbody_const() const {
        return tools::static_pointer_cast<KinBody const>(shared_from_this());
    }
