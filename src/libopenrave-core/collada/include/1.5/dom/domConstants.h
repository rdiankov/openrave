...
//	OpenRAVE sensors
extern DLLSPEC daeString COLLADA_ELEMENT_SENSOR;
extern DLLSPEC daeString COLLADA_ELEMENT_INSTANCE_SENSOR;
extern DLLSPEC daeString COLLADA_ELEMENT_LIBRARY_SENSORS;
