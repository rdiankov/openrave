...
typedef OPENRAVE_SHARED_PTR<ColladaXMLReadable> ColladaXMLReadablePtr;
...
OPENRAVE_SHARED_PTR<DAE> GetGlobalDAE(bool resetdefaults=true);
/// \brief reset the global DAE
void SetGlobalDAE(OPENRAVE_SHARED_PTR<DAE>);
