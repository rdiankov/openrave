...
//static tools::shared_ptr<boost::thread> s_mainThread;
static string s_sceneFile;
static string s_saveScene; // if not NULL, saves the scene and exits
static tools::shared_ptr<string> s_viewerName;
...
int main(int argc, char ** argv)
{
    ...
    //s_mainThread.reset(new boost::thread(tools::bind(MainOpenRAVEThread)));
    //s_mainThread->join();
    MainOpenRAVEThread();
    {
