...
{
    return InterfaceBase::SetReadableInterface(id, readable);
}

void KinBody::SetReadableInterfaces(const READERSMAP& mapReadables, bool bClearAllExisting)
{
    InterfaceBase::SetReadableInterfaces(mapReadables, bClearAllExisting);
}

bool KinBody::UpdateReadableInterfaces(const std::map<std::string, ReadablePtr>& newReadableInterfaces)
{
    return InterfaceBase::UpdateReadableInterfaces(newReadableInterfaces);
}
