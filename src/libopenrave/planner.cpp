...
PlannerParameters& PlannerParameters::operator=(const PlannerParameters& r)
{
    ...
    _getConstraintCheckerParamsFn = r._getConstraintCheckerParamsFn;
...
void PlannerParameters::SetRobotActiveJoints(RobotBasePtr& robot)
{
    ...
    _getConstraintCheckerParamsFn = boost::bind(&DynamicsCollisionConstraint::GetDynamicsCollisionConstraintParameters, pcollision, _1, _2);
