...
KinBody::JointInfo::JointInfo() : XMLReadable("joint"), _type(JointNone), _bIsActive(true) {
    ...
    std::fill(_vmaxjerk.begin(), _vmaxjerk.end(), 50*100); // Set negligibly large jerk by default which can change acceleration between min and max within a typical time step.
