...
public:
    ...
    {
public:
        PIDXMLReader(tools::shared_ptr<XMLData> piddata, const AttributesList& atts) {
            _piddata = piddata;
            if( !_piddata )
...
protected:
        tools::shared_ptr<XMLData> _piddata;
        stringstream _ss;
    };
    ...
    static BaseXMLReaderPtr CreateXMLReader(InterfaceBasePtr ptr, const AttributesList& atts)
    {
        ...
        return BaseXMLReaderPtr(new PIDXMLReader(tools::shared_ptr<XMLData>(),atts));
    }
    ...
    virtual bool Init(RobotBasePtr robot, const std::vector<int>& dofindices, int nControlTransformation)
    {
        ...
        tools::shared_ptr<XMLData> piddata = tools::dynamic_pointer_cast<XMLData>(GetReadableInterface("piddata"));
        if( !!piddata ) {
            stringstream ss;
...
static tools::shared_ptr<void> s_RegisteredReader;
