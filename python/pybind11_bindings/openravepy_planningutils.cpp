...
{
    {
        ...
        .def(init<>())
        .def(init<object, int, object, dReal, dReal, dReal, dReal>(PY_ARGS("joint","parentindex","transform","d","a","theta","alpha")))
        ...
        .def(init<object, object, optional<int, int, dReal, bool, int, object> >(PY_ARGS("manip", "parameterizations", "nummaxsamples", "nummaxtries", "jitter","searchfreeparameters","ikfilteroptions","freevalues")))
        ...
        .def(init<PyRobotBasePtr, const std::string&, const std::string&>(PY_ARGS("robot", "plannername", "plannerparameters")))
        ...
        .def(init<PyRobotBasePtr, const std::string&, const std::string&>(PY_ARGS("robot", "hastimestamps", "plannername", "plannerparameters")))
        ...
        .def(init<const std::string&, const std::string&>(PY_ARGS("plannername", "plannerparameters")))
        ...
        .def(init<object, object, uint32_t>(PY_ARGS("plannerparameters", "checkbodies", "filtermask")))
