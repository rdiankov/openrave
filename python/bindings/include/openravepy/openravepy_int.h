...
OPENRAVEPY_API PyEnvironmentBasePtr GetPyEnvironment(const EnvironmentBasePtr&);
OPENRAVEPY_API py::object GetPyEnvironmentObject(const EnvironmentBasePtr&);
...
OPENRAVEPY_API PyInterfaceBasePtr toPyKinBody(const KinBodyPtr&, PyEnvironmentBasePtr);
OPENRAVEPY_API py::object toPyKinBody(const KinBodyPtr&, py::object opyenv);
OPENRAVEPY_API py::object toPyKinBodyLink(const KinBody::LinkPtr& plink, PyEnvironmentBasePtr);
OPENRAVEPY_API py::object toPyKinBodyLink(const KinBody::LinkPtr& plink, py::object opyenv);
OPENRAVEPY_API py::object toPyKinBodyGeometry(const KinBody::GeometryPtr& pgeom);
OPENRAVEPY_API KinBody::LinkPtr GetKinBodyLink(py::object);
OPENRAVEPY_API KinBody::LinkConstPtr GetKinBodyLinkConst(py::object);
OPENRAVEPY_API py::object toPyKinBodyJoint(const KinBody::JointPtr& pjoint, PyEnvironmentBasePtr);
