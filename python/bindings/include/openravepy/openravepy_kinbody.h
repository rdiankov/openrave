...
public:
    ...
    bool IsGrabbingWithLink(PyKinBodyPtr pbody, py::object pylink) const;
    bool IsGrabbingWithLink(PyKinBodyPtr pbody, py::object pylink, py::object linkstoignore) const;
