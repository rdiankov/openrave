...
void PlannerBaseInitializer::init_openravepy_planner()
{
    ...
    object plannerstatuscode = enum_<PlannerStatusCode>("PlannerStatusCode" DOXY_ENUM(PlannerStatusCode))
                               ...
                               .value("FailedDueToEnvCollision",PS_FailedDueToEnvCollision)
                               .value("FailedDueToSelfCollision",PS_FailedDueToSelfCollision)
                               .value("FailedDueToCollision",PS_FailedDueToCollision)
                               .value("FailedDueToInitial",PS_FailedDueToInitial)
                               .value("FailedDueToGoal",PS_FailedDueToGoal)
                               .value("FailedDueToKinematics",PS_FailedDueToKinematics)
                               .value("FailedDueToIK",PS_FailedDueToIK)
                               .value("FailedDueToVelocityConstraints",PS_FailedDueToVelocityConstraints)
                               .value("FailedDueToCustomFilter",PS_FailedDueToCustomFilter)
                               .value("FailedDueToTimeBasedConstraints",PS_FailedDueToTimeBasedConstraints)
    ;
#ifdef USE_PYBIND11_PYTHON_BINDINGS
