...
class openrave_exception_helper(Exception):
    ...
    def __getattribute__(self, attr):
        my_pimpl = super(openravepy_int.openrave_exception, self).__getattribute__("_pimpl")
        try:
            return getattr(my_pimpl, attr)
        except AttributeError:
            return super(openravepy_int.openrave_exception,self).__getattribute__(attr)
