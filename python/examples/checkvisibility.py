...
.. image:: ../../images/examples/checkvisibility.jpg
  :width: 300
...
Uses the `databases.VisibilityModel` database generator and :ref:`probleminstance-visualfeedback` interface.

Command-line
------------

.. shell-block:: openrave.py --example checkvisibility --help
