...
class VisualFeedback:
    ...
    def ProcessVisibilityExtents(self,numrolls=None,transforms=None,extents=None,sphere=None,conedirangles=None):
        ...
        return numpy.reshape(visibilitytransforms,(int(len(visibilitytransforms)/7),7))
    ...
    def SampleVisibilityGoal(self,numsamples=None):
        ...
        return numpy.reshape(numpy.array(samples[1:],float),(returnedsamples,int(len(samples)-1)/returnedsamples))
