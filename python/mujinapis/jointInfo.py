...
jointInfoSchema = {  # TODO(felixvd): Link from openrave kinbody.JointInfo
    ...
    "properties": {
        ...
        "resolutions": {
            ...
            "typeName": "boost::array<dReal,3>",
            "default": "boost::array<dReal,3>{0.02, 0.02, 0.02}",
        },
        "maxVel": {
            "type": "array",
            "items": {"type": "number"},
            ...
            "typeName": "boost::array<dReal,3>",
            "default": "boost::array<dReal,3>{1, 1, 1}",
        },
        "hardMaxVel": {
            "type": "array",
            "items": {"type": "number"},
            ...
            "typeName": "boost::array<dReal,3>",
            "default": "boost::array<dReal,3>{0, 0, 0}",
        },
        "maxAccel": {
            "type": "array",
            "items": {"type": "number"},
            ...
            "typeName": "boost::array<dReal,3>",
            "default": "boost::array<dReal,3>{50, 50, 50}",
        },
        "hardMaxAccel": {
            "type": "array",
            "items": {"type": "number"},
        ...
        "maxJerk": {
            ...
            "typeName": "boost::array<dReal,3>",
            "default": "boost::array<dReal,3>{50*1000, 50*1000, 50*1000}",
        },
        "hardMaxJerk": {
            "type": "array",
            "items": {"type": "number"},
        ...
        "offsets": {
            ...
            "description": _("Wrap offsets are needed for rotation joints since the range is limited to 2*pi. This allows the wrap offset to be set so the joint can function in [-pi+offset,pi+offset].")
        },
        "lowerLimit": {
            "type": "array",
            "items": {"type": "number"},
