...
int BodyConfigurationSampler::SampleSequence(std::vector<dReal>& samples, size_t num=1,IntervalType interval=IT_Closed)
{
...
bool BodyConfigurationSampler::SetDOFsCommand(ostream& sout, istream& sinput)
{
