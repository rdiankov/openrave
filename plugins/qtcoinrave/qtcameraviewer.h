...
public:
        QtImageWindow(SensorBasePtr psensor) : QWidget(NULL), _psensor(psensor) {
            _pdata = OPENRAVE_STATIC_POINTER_CAST<SensorBase::CameraSensorData>(_psensor->CreateSensorData(SensorBase::ST_Camera));
            _pdatanew = OPENRAVE_STATIC_POINTER_CAST<SensorBase::CameraSensorData>(_psensor->CreateSensorData(SensorBase::ST_Camera));
            _pgeom = OPENRAVE_STATIC_POINTER_CAST<SensorBase::CameraGeomData const>(_psensor->GetSensorGeometry(SensorBase::ST_Camera));
            if( !_pdata || !_pgeom ) {
...
private:
        ...
        OPENRAVE_SHARED_PTR<SensorBase::CameraSensorData> _pdatanew, _pdata;
    ...
    static void _DestroyImageWindow(OPENRAVE_SHARED_PTR<QtImageWindow> imagewindow)
    {
    }

    SensorBasePtr _psensor;
    OPENRAVE_SHARED_PTR<QtImageWindow> _imagewindow;
    boost::mutex _mutex;
};
