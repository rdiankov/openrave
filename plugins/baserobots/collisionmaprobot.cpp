...
public:
    ...
    {
public:
        CollisionMapXMLReader(tools::shared_ptr<XMLData> cmdata, const AttributesList& atts) {
            _cmdata = cmdata;
            if( !_cmdata ) {
...
protected:
        tools::shared_ptr<XMLData> _cmdata;
        stringstream _ss;
    };
    ...
    static BaseXMLReaderPtr CreateXMLReader(InterfaceBasePtr ptr, const AttributesList& atts)
    {
        ...
        return BaseXMLReaderPtr(new CollisionMapXMLReader(tools::shared_ptr<XMLData>(),atts));
    }
...
";
    ...
    virtual void _ComputeInternalInformation()
    {
        ...
        tools::shared_ptr<XMLData> cmdata = tools::dynamic_pointer_cast<XMLData>(GetReadableInterface("collisionmap"));
        if( !!cmdata ) {
