...
if(_odeconfig_cflags AND _odeconfig_lflags)
  ...
  if( MSVC )
    ...
    set( ODE_INCLUDE_DIRS "${CMAKE_SOURCE_DIR}/inc" )
    set( ODE_LINK_DIRS "" )
    set( ODE_PRECISION "DOUBLE")
    if( MSVC70 AND MSVC71 AND MSVC80 )
  	  set( ODE_LIBRARY ode_double-vc80-mt-0.11.1)
    elseif( MSVC90 )
      set( ODE_LIBRARY ode_double-vc90-mt-0.11.1)
    else()
      set( ODE_LIBRARY ode_double-vc100-mt-0.11.1)
    endif()
    set( ODE_LIBRARY_RELEASE ${ODE_LIBRARY})
    set( ODE_LIBRARY_DEBUG ${ODE_LIBRARY})
  else()
