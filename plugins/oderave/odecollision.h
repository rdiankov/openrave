...
class ODECollisionChecker : public OpenRAVE::CollisionCheckerBase
{
    ...
    {
    public:
        CollisionCallbackData(OPENRAVE_SHARED_PTR<ODECollisionChecker> pchecker, CollisionReportPtr report, KinBodyConstPtr pbody, KinBody::LinkConstPtr plink) : _pchecker(pchecker), _report(report), _pbody(pbody), _plink(plink), fraymaxdist(0), pvbodyexcluded(NULL), pvlinkexcluded(NULL), _bCollision(false), _bStopChecking(false)
        {
        ...
        OPENRAVE_SHARED_PTR<ODECollisionChecker> _pchecker;
...
private:
    ...
    inline OPENRAVE_SHARED_PTR<ODECollisionChecker> shared_checker() {
        return OPENRAVE_STATIC_POINTER_CAST<ODECollisionChecker>(shared_from_this());
    }
    inline OPENRAVE_SHARED_PTR<ODECollisionChecker const> shared_checker_const() const {
        return OPENRAVE_STATIC_POINTER_CAST<ODECollisionChecker const>(shared_from_this());
    }
...
public:
    ...
    void Clone(InterfaceBaseConstPtr preference, int cloningoptions)
    {
        ...
        OPENRAVE_SHARED_PTR<ODECollisionChecker const > r = OPENRAVE_DYNAMIC_POINTER_CAST<ODECollisionChecker const>(preference);
...
//        }
    ...
    {
        ODESpace::KinBodyInfoPtr pinfo = OPENRAVE_DYNAMIC_POINTER_CAST<ODESpace::KinBodyInfo>(pbody->GetUserData(_userdatakey));
...
private:
    ...
    OPENRAVE_SHARED_PTR<ODESpace> _odespace;
