...
public:
    ...
    virtual void Reset(int options)
    {
        if( !!_probot ) {
            ...
            if( !!pinfo ) {
                OpenRAVE::tools::shared_ptr<ODESpace> odespace(pinfo->_odespace);
            ...
            _torquechangedhandle = _probot->RegisterChangeCallback(KinBody::Prop_JointAccelerationVelocityTorqueLimits, OpenRAVE::tools::bind(&ODEVelocityController::_TorqueChanged,this));
        }
    ...
    virtual ODESpace::KinBodyInfoPtr GetODESpace() {
        return OpenRAVE::tools::dynamic_pointer_cast<ODESpace::KinBodyInfo>(_probot->GetUserData("odephysics"));
    }
