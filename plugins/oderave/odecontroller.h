...
public:
    ...
    virtual void Reset(int options)
    {
        if( !!_probot ) {
            ...
            _torquechangedhandle = _probot->RegisterChangeCallback(KinBody::Prop_JointAccelerationVelocityTorqueLimits, std::bind(&ODEVelocityController::_TorqueChanged,this));
        }
