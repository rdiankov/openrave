...
public:
    ...
    virtual void Reset(int options)
    {
        if( !!_probot ) {
            ...
            if( !!pinfo ) {
                tools::shared_ptr<ODESpace> odespace(pinfo->_odespace);
            ...
            _torquechangedhandle = _probot->RegisterChangeCallback(KinBody::Prop_JointAccelerationVelocityTorqueLimits, tools::bind(&ODEVelocityController::_TorqueChanged,this));
        }
    ...
    virtual ODESpace::KinBodyInfoPtr GetODESpace() {
        return tools::dynamic_pointer_cast<ODESpace::KinBodyInfo>(_probot->GetUserData("odephysics"));
    }
