...
#ifndef OPENRAVE_PLUGIN_ODERAVE_H
#define OPENRAVE_PLUGIN_ODERAVE_H
...
struct ODERavePlugin : public RavePlugin {
    ODERavePlugin()
    {
    ...
    {
        static std::string pluginname = "ODERavePlugin";
        return pluginname;
    }
...
#endif // OPENRAVE_PLUGIN_ODERAVE_H