...
typedef OPENRAVE_SHARED_PTR<fcl::BroadPhaseCollisionManager> BroadPhaseCollisionManagerPtr;
typedef OPENRAVE_WEAK_PTR<fcl::BroadPhaseCollisionManager> BroadPhaseCollisionManagerWeakPtr;
...
class FCLCollisionManagerInstance : public OPENRAVE_ENABLE_SHARED_FROM_THIS<FCLCollisionManagerInstance>
{
...
typedef OPENRAVE_SHARED_PTR<FCLCollisionManagerInstance> FCLCollisionManagerInstancePtr;
typedef OPENRAVE_WEAK_PTR<FCLCollisionManagerInstance> FCLCollisionManagerInstanceWeakPtr;
