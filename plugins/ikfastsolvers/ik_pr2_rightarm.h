...
///
/// generated 2010-12-07 21:48:09.834522
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x12=IKsin(j[6]);
x13=IKcos(j[6]);
eerot[0]=((((-1.00000000000000)*(x0)*(x5)*(x6)*(x7)*(x8)*(x9)))+(((-1.00000000000000)*(x1)*(x10)*(x2)*(x4)))+(((x0)*(x11)*(x2)*(x5)*(x8)))+(((-1.00000000000000)*(x0)*(x1)*(x4)*(x8)*(x9)))+(((x0)*(x1)*(x3)*(x6)))+(((-1.00000000000000)*(x10)*(x11)*(x5)*(x9)))+(((-1.00000000000000)*(x10)*(x2)*(x5)*(x6)*(x7)))+(((-1.00000000000000)*(x0)*(x3)*(x4)*(x5)*(x7))));
eerot[1]=((((x0)*(x13)*(x2)*(x7)*(x8)))+(((x0)*(x1)*(x12)*(x3)*(x4)*(x7)))+(((x1)*(x10)*(x12)*(x2)*(x6)*(x7)))+(((-1.00000000000000)*(x0)*(x1)*(x11)*(x12)*(x2)*(x8)))+(((-1.00000000000000)*(x0)*(x12)*(x4)*(x5)*(x8)*(x9)))+(((x0)*(x12)*(x3)*(x5)*(x6)))+(((x1)*(x10)*(x11)*(x12)*(x9)))+(((x10)*(x11)*(x13)*(x2)*(x6)))+(((-1.00000000000000)*(x10)*(x12)*(x2)*(x4)*(x5)))+(((-1.00000000000000)*(x10)*(x13)*(x7)*(x9)))+(((x0)*(x11)*(x13)*(x6)*(x8)*(x9)))+(((x0)*(x1)*(x12)*(x6)*(x7)*(x8)*(x9)))+(((x0)*(x11)*(x13)*(x3)*(x4))));
eerot[2]=((((x0)*(x1)*(x13)*(x3)*(x4)*(x7)))+(((x1)*(x10)*(x11)*(x13)*(x9)))+(((-1.00000000000000)*(x0)*(x11)*(x12)*(x3)*(x4)))+(((x0)*(x1)*(x13)*(x6)*(x7)*(x8)*(x9)))+(((x10)*(x12)*(x7)*(x9)))+(((-1.00000000000000)*(x10)*(x11)*(x12)*(x2)*(x6)))+(((-1.00000000000000)*(x0)*(x12)*(x2)*(x7)*(x8)))+(((-1.00000000000000)*(x0)*(x1)*(x11)*(x13)*(x2)*(x8)))+(((x0)*(x13)*(x3)*(x5)*(x6)))+(((-1.00000000000000)*(x0)*(x13)*(x4)*(x5)*(x8)*(x9)))+(((x1)*(x10)*(x13)*(x2)*(x6)*(x7)))+(((-1.00000000000000)*(x10)*(x13)*(x2)*(x4)*(x5)))+(((-1.00000000000000)*(x0)*(x11)*(x12)*(x6)*(x8)*(x9))));
eetrans[0]=((((-0.180000000000000)*(x10)*(x2)*(x5)*(x6)*(x7)))+(((0.180000000000000)*(x0)*(x11)*(x2)*(x5)*(x8)))+(((0.400000000000000)*(x0)*(x3)))+(((0.180000000000000)*(x0)*(x1)*(x3)*(x6)))+(((-0.321000000000000)*(x0)*(x4)*(x8)*(x9)))+(((-0.180000000000000)*(x10)*(x11)*(x5)*(x9)))+(((-0.321000000000000)*(x10)*(x2)*(x4)))+(((-0.180000000000000)*(x0)*(x3)*(x4)*(x5)*(x7)))+(((0.100000000000000)*(x0)))+(((-0.180000000000000)*(x1)*(x10)*(x2)*(x4)))+(((0.321000000000000)*(x0)*(x3)*(x6)))+(((-0.180000000000000)*(x0)*(x5)*(x6)*(x7)*(x8)*(x9)))+(((-0.180000000000000)*(x0)*(x1)*(x4)*(x8)*(x9))));
eerot[3]=((((x0)*(x2)*(x5)*(x6)*(x7)))+(((x1)*(x10)*(x3)*(x6)))+(((x0)*(x11)*(x5)*(x9)))+(((x0)*(x1)*(x2)*(x4)))+(((-1.00000000000000)*(x1)*(x10)*(x4)*(x8)*(x9)))+(((-1.00000000000000)*(x10)*(x5)*(x6)*(x7)*(x8)*(x9)))+(((-1.00000000000000)*(x10)*(x3)*(x4)*(x5)*(x7)))+(((x10)*(x11)*(x2)*(x5)*(x8))));
eerot[4]=((((x1)*(x10)*(x12)*(x6)*(x7)*(x8)*(x9)))+(((-1.00000000000000)*(x1)*(x10)*(x11)*(x12)*(x2)*(x8)))+(((x10)*(x11)*(x13)*(x3)*(x4)))+(((x0)*(x12)*(x2)*(x4)*(x5)))+(((x10)*(x13)*(x2)*(x7)*(x8)))+(((-1.00000000000000)*(x0)*(x1)*(x12)*(x2)*(x6)*(x7)))+(((-1.00000000000000)*(x10)*(x12)*(x4)*(x5)*(x8)*(x9)))+(((x0)*(x13)*(x7)*(x9)))+(((x1)*(x10)*(x12)*(x3)*(x4)*(x7)))+(((-1.00000000000000)*(x0)*(x1)*(x11)*(x12)*(x9)))+(((x10)*(x12)*(x3)*(x5)*(x6)))+(((-1.00000000000000)*(x0)*(x11)*(x13)*(x2)*(x6)))+(((x10)*(x11)*(x13)*(x6)*(x8)*(x9))));
eerot[5]=((((-1.00000000000000)*(x10)*(x12)*(x2)*(x7)*(x8)))+(((x1)*(x10)*(x13)*(x3)*(x4)*(x7)))+(((x0)*(x11)*(x12)*(x2)*(x6)))+(((-1.00000000000000)*(x10)*(x11)*(x12)*(x6)*(x8)*(x9)))+(((-1.00000000000000)*(x10)*(x11)*(x12)*(x3)*(x4)))+(((-1.00000000000000)*(x1)*(x10)*(x11)*(x13)*(x2)*(x8)))+(((x1)*(x10)*(x13)*(x6)*(x7)*(x8)*(x9)))+(((x0)*(x13)*(x2)*(x4)*(x5)))+(((-1.00000000000000)*(x0)*(x1)*(x13)*(x2)*(x6)*(x7)))+(((x10)*(x13)*(x3)*(x5)*(x6)))+(((-1.00000000000000)*(x10)*(x13)*(x4)*(x5)*(x8)*(x9)))+(((-1.00000000000000)*(x0)*(x12)*(x7)*(x9)))+(((-1.00000000000000)*(x0)*(x1)*(x11)*(x13)*(x9))));
eetrans[1]=((-0.188000000000000)+(((0.321000000000000)*(x10)*(x3)*(x6)))+(((-0.180000000000000)*(x10)*(x5)*(x6)*(x7)*(x8)*(x9)))+(((0.180000000000000)*(x10)*(x11)*(x2)*(x5)*(x8)))+(((-0.180000000000000)*(x10)*(x3)*(x4)*(x5)*(x7)))+(((0.180000000000000)*(x0)*(x1)*(x2)*(x4)))+(((0.180000000000000)*(x1)*(x10)*(x3)*(x6)))+(((0.100000000000000)*(x10)))+(((0.180000000000000)*(x0)*(x11)*(x5)*(x9)))+(((-0.321000000000000)*(x10)*(x4)*(x8)*(x9)))+(((-0.180000000000000)*(x1)*(x10)*(x4)*(x8)*(x9)))+(((0.180000000000000)*(x0)*(x2)*(x5)*(x6)*(x7)))+(((0.321000000000000)*(x0)*(x2)*(x4)))+(((0.400000000000000)*(x10)*(x3))));
eerot[6]=((((-1.00000000000000)*(x1)*(x3)*(x4)*(x9)))+(((x4)*(x5)*(x7)*(x8)))+(((-1.00000000000000)*(x3)*(x5)*(x6)*(x7)*(x9)))+(((-1.00000000000000)*(x1)*(x6)*(x8)))+(((x11)*(x2)*(x3)*(x5))));
eerot[7]=((((x11)*(x13)*(x3)*(x6)*(x9)))+(((-1.00000000000000)*(x12)*(x5)*(x6)*(x8)))+(((x13)*(x2)*(x3)*(x7)))+(((-1.00000000000000)*(x1)*(x12)*(x4)*(x7)*(x8)))+(((-1.00000000000000)*(x12)*(x3)*(x4)*(x5)*(x9)))+(((-1.00000000000000)*(x11)*(x13)*(x4)*(x8)))+(((x1)*(x12)*(x3)*(x6)*(x7)*(x9)))+(((-1.00000000000000)*(x1)*(x11)*(x12)*(x2)*(x3))));
eerot[8]=((((-1.00000000000000)*(x13)*(x3)*(x4)*(x5)*(x9)))+(((-1.00000000000000)*(x1)*(x11)*(x13)*(x2)*(x3)))+(((-1.00000000000000)*(x1)*(x13)*(x4)*(x7)*(x8)))+(((-1.00000000000000)*(x13)*(x5)*(x6)*(x8)))+(((-1.00000000000000)*(x12)*(x2)*(x3)*(x7)))+(((x11)*(x12)*(x4)*(x8)))+(((x1)*(x13)*(x3)*(x6)*(x7)*(x9)))+(((-1.00000000000000)*(x11)*(x12)*(x3)*(x6)*(x9))));
eetrans[2]=((((-0.321000000000000)*(x6)*(x8)))+(((-0.180000000000000)*(x3)*(x5)*(x6)*(x7)*(x9)))+(((-0.321000000000000)*(x3)*(x4)*(x9)))+(((-0.180000000000000)*(x1)*(x3)*(x4)*(x9)))+(((0.180000000000000)*(x4)*(x5)*(x7)*(x8)))+(((-0.180000000000000)*(x1)*(x6)*(x8)))+(((0.180000000000000)*(x11)*(x2)*(x3)*(x5)))+(((-0.400000000000000)*(x8))));
}
...
IKFAST_API const char* getKinematicsHash() { return "0fbd946137ccf091bf14b48aad26b9b9"; }
