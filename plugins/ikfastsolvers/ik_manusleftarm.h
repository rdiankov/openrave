...
///
/// generated 2011-01-12 18:47:37.085782
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[0]=((0.0454160000000000)+(((-0.405000000000000)*(x2)*(x4)))+(((-0.331000000000000)*(x2)*(x4)*(x9)))+(((-0.100150000000000)*(x1)))+(((0.331000000000000)*(x10)*(x4)*(x7))));
...
eetrans[1]=((0.302408000000000)+(((0.405000000000000)*(x10)))+(((0.331000000000000)*(x2)*(x7)))+(((0.331000000000000)*(x10)*(x9))));
...
eetrans[2]=((0.467052000000000)+(((0.331000000000000)*(x1)*(x2)*(x9)))+(((-0.331000000000000)*(x1)*(x10)*(x7)))+(((0.405000000000000)*(x1)*(x2)))+(((-0.100150000000000)*(x4))));
}
...
new_r02=r01;
new_px=((-0.0454160000000000)+(px));
new_r10=r10;
new_r11=((-1.00000000000000)*(r12));
new_r12=r11;
new_py=((-0.302408000000000)+(py));
new_r20=r20;
new_r21=((-1.00000000000000)*(r22));
new_r22=r21;
new_pz=((-0.467052000000000)+(pz));
...
cj2array[0]=((-1.05783455484689)+(((3.72981239043676)*((py)*(py))))+(((3.72981239043676)*((px)*(px))))+(((3.72981239043676)*((pz)*(pz)))));
...
{
IKReal dummyeval[1];
dummyeval[0]=((((-0.405000000000000)*(py)))+(((-0.331000000000000)*(cj0)*(pz)*(sj2)))+(((-0.331000000000000)*(cj2)*(py)))+(((0.331000000000000)*(px)*(sj0)*(sj2))));
if( IKabs(dummyeval[0]) < 0.000001  )
{
{
IKReal dummyeval[1];
dummyeval[0]=((0.164025000000000)+(((0.109561000000000)*((sj2)*(sj2))))+(((0.268110000000000)*(cj2)))+(((0.109561000000000)*((cj2)*(cj2)))));
if( IKabs(dummyeval[0]) < 0.000001  )
{
{
IKReal dummyeval[1];
dummyeval[0]=((((0.331000000000000)*(cj2)*(px)*(sj0)))+(((0.405000000000000)*(px)*(sj0)))+(((-0.331000000000000)*(cj0)*(cj2)*(pz)))+(((-0.405000000000000)*(cj0)*(pz)))+(((0.331000000000000)*(py)*(sj2))));
if( IKabs(dummyeval[0]) < 0.000001  )
{
{
IKReal evalcond[3];
...
IKReal j1array[2], cj1array[2], sj1array[2];
bool j1valid[2]={false};
cj1array[0]=((((-13.5135135135135)*(px)*(sj0)))+(((13.5135135135135)*(cj0)*(pz))));
if( cj1array[0] >= -1.0001 && cj1array[0] <= 1.0001 )
{
    j1valid[0] = j1valid[1] = true;
    j1array[0] = IKacos(cj1array[0]);
...
IKReal x40=((1.00000000000000)*(px)*(sj0)*(x38));
IKReal x41=((0.405000000000000)*(px)*(sj0));
IKReal x42=((0.331000000000000)*(py)*(sj2));
IKReal x43=((x42)+(x40)+(x41));
IKReal x44=((0.405000000000000)*(cj0)*(pz));
IKReal x45=((1.00000000000000)*(cj0)*(pz)*(x38));
IKReal x46=((x44)+(x45));
IKReal x47=((((-1.00000000000000)*(x46)))+(x43));
IKReal x48=((IKabs(x47) != 0)?((IKReal)1/(x47)):(IKReal)1.0e30);
j1array[0]=IKatan2(((x48)*(((((0.331000000000000)*(sj2)*(x39)))+(((py)*(((((-1.00000000000000)*(cj0)*(pz)))+(((px)*(sj0)))))))))), ((x48)*(((((-1.00000000000000)*((x39)*(x39))))+((py)*(py))))));
sj1array[0]=IKsin(j1array[0]);
...
IKReal x51=((0.268110000000000)*(cj2));
IKReal x52=(cj2)*(cj2);
IKReal x53=((0.109561000000000)*(x52));
IKReal x54=((0.164025000000000)+(x51)+(x50)+(x53));
IKReal x55=((IKabs(x54) != 0)?((IKReal)1/(x54)):(IKReal)1.0e30);
IKReal x56=((px)*(sj0));
IKReal x57=((cj0)*(pz));
IKReal x58=((x56)+(((-1.00000000000000)*(x57))));
j1array[0]=IKatan2(((x55)*(((((py)*(((0.405000000000000)+(((0.331000000000000)*(cj2)))))))+(((0.331000000000000)*(sj2)*(x58)))))), ((x55)*(((((-1.00000000000000)*(x58)*(((0.405000000000000)+(((0.331000000000000)*(cj2)))))))+(((0.331000000000000)*(py)*(sj2)))))));
sj1array[0]=IKsin(j1array[0]);
cj1array[0]=IKcos(j1array[0]);
if( j1array[0] > IKPI )
    j1array[0]-=IK2PI;
...
IKReal x60=((0.331000000000000)*(cj0)*(pz)*(sj2));
IKReal x61=((0.331000000000000)*(cj2)*(py));
IKReal x62=((0.405000000000000)*(py));
IKReal x63=((x60)+(x61)+(x62));
IKReal x64=((x59)+(((-1.00000000000000)*(x63))));
IKReal x65=((IKabs(x64) != 0)?((IKReal)1/(x64)):(IKReal)1.0e30);
j1array[0]=IKatan2(((x65)*(((((0.109561000000000)*((sj2)*(sj2))))+(((-1.00000000000000)*((py)*(py))))))), ((-1.00000000000000)*(x65)*(((((py)*(((((-1.00000000000000)*(px)*(sj0)))+(((cj0)*(pz)))))))+(((0.331000000000000)*(sj2)*(((0.405000000000000)+(((0.331000000000000)*(cj2)))))))))));
sj1array[0]=IKsin(j1array[0]);
cj1array[0]=IKcos(j1array[0]);
if( j1array[0] > IKPI )
    j1array[0]-=IK2PI;
