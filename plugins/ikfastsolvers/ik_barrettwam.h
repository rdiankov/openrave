...
///
/// generated 2010-12-10 19:04:02.636834
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
j6array[0]=IKatan2(((new_r00)*(x64)), ((-1.00000000000000)*(new_r02)*(x64)));
...
IKReal x67=IKcos(j4);
IKReal x68=IKsin(j4);
j6array[0]=IKatan2(((((new_r02)*(x66)*(x67)))+(((new_r22)*(x66)*(x68)))), ((((new_r22)*(x67)))+(((-1.00000000000000)*(new_r02)*(x68)))));
sj6array[0]=IKsin(j6array[0]);
cj6array[0]=IKcos(j6array[0]);
if( j6array[0] > IKPI )
    j6array[0]-=IK2PI;
...
j6array[0]=IKatan2(((new_r12)*(x70)), ((new_r10)*(x70)));
sj6array[0]=IKsin(j6array[0]);
cj6array[0]=IKcos(j6array[0]);
if( j6array[0] > IKPI )
    j6array[0]-=IK2PI;
