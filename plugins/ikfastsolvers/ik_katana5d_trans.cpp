...
///
/// ikfast version 47 generated on 2011-10-01 16:08:59.274538
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
if( IKabs(py)+IKabs(x8) < IKFAST_ATAN2_MAGTHRESH )
    continue;
...
if( IKabs(x25)+IKabs(x12) < IKFAST_ATAN2_MAGTHRESH )
    continue;
...
if( IKabs(x35)+IKabs(x48) < IKFAST_ATAN2_MAGTHRESH )
    continue;
...
if( IKabs(((gconst1)*(((((2.88750000000000)*(cj0)*(px)))+(((5.18700000000000)*(cj2)*(pz)*(sj3)))+(((-50.0000000000000)*(pp)*(py)*(sj0)))+(((3.79470000000000)*(cj3)*(py)*(sj0)))+(((2.88750000000000)*(py)*(sj0)))+(((-5.18700000000000)*(cj3)*(pz)*(sj2)))+(((3.79470000000000)*(cj0)*(cj3)*(px)))+(((-50.0000000000000)*(cj0)*(pp)*(px)))+(((-2.64100000000000)*(pz)*(sj2)))))))+IKabs(((gconst1)*(((((-2.64100000000000)*(py)*(sj0)*(sj2)))+(((-2.64100000000000)*(cj0)*(px)*(sj2)))+(((-5.18700000000000)*(cj0)*(cj3)*(px)*(sj2)))+(((-2.88750000000000)*(pz)))+(((-5.18700000000000)*(cj3)*(py)*(sj0)*(sj2)))+(((50.0000000000000)*(pp)*(pz)))+(((-3.79470000000000)*(cj3)*(pz)))+(((5.18700000000000)*(cj0)*(cj2)*(px)*(sj3)))+(((5.18700000000000)*(cj2)*(py)*(sj0)*(sj3))))))) < IKFAST_ATAN2_MAGTHRESH )
    continue;
...
if( IKabs(x51)+IKabs(x64) < IKFAST_ATAN2_MAGTHRESH )
    continue;
