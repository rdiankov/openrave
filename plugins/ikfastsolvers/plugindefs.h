...
IkSolverBasePtr CreateIkFastSolver(const EnvironmentBasePtr& penv, std::istream& sinput, boost::shared_ptr<ikfast::IkFastFunctions<float> > ikfunctions, const std::vector<dReal>& vfreeinc, dReal ikthreshold=1e-4);
#endif
IkSolverBasePtr CreateIkFastSolver(const EnvironmentBasePtr& penv, std::istream& sinput, boost::shared_ptr<ikfast::IkFastFunctions<double> > ikfunctions, const std::vector<dReal>& vfreeinc, dReal ikthreshold=1e-4);
