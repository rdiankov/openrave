...
///
/// generated 2010-10-28 23:01:52.465258
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
IKFAST_API void fk(const IKReal* j, IKReal* eetrans, IKReal* eerot) {
    ...
    x19=IKcos(j[2]);
    x20=IKsin(j[1]);
    x21=((0.999135601564979)*(x18)*(x7));
    x22=((0.999135601564979)*(x1)*(x17)*(x3));
    x23=((x21)+(x22));
    x24=((x0)*(x23));
    x25=((0.999135601564979)*(x17)*(x2)*(x4));
    x26=((((-1.00000000000000)*(x25)))+(x24));
    x27=((0.0415698169996759)*(x18)*(x7));
    x28=((0.0415698169996759)*(x1)*(x17)*(x3));
    x29=((x27)+(x28));
    x30=((0.0415698169996759)*(x17)*(x2)*(x4));
    x31=((0.0415698169996759)*(x1)*(x18));
    x32=((0.0415698169996759)*(x17)*(x3)*(x7));
    x33=((((-1.00000000000000)*(x32)))+(x31));
    x34=((0.999135601564979)*(x17)*(x3)*(x7));
    x35=((0.999135601564979)*(x1)*(x18));
    x36=((0.999135601564979)*(x1)*(x17));
    x37=((x21)*(x3));
    x38=((x37)+(x36));
    x39=((x3)*(x35));
    x40=((0.999135601564979)*(x17)*(x7));
    x41=((((-1.00000000000000)*(x40)))+(x39));
    x42=((x0)*(x41));
    x43=((0.999135601564979)*(x18)*(x2)*(x4));
    x44=((((-1.00000000000000)*(x43)))+(x42));
    x45=((x3)*(x31));
    x46=((0.0415698169996759)*(x17)*(x7));
    x47=((0.0415698169996759)*(x18)*(x2)*(x4));
    x48=((x27)*(x3));
    ...
    x55=((x19)*(x54));
    x56=((x11)*(x6));
    x57=((0.999135601564979)*(x2)*(x5)*(x7));
    x58=((x14)*(x5));
    x59=((0.0415698169996759)*(x2)*(x6)*(x7));
    x60=((x59)+(x58)+(x57)+(x56));
    x61=((x16)*(x60));
    x62=((x55)+(x61));
    x63=((-1.00000000000000)*(x14));
    x64=((x6)*(x63));
    x65=((x11)*(x5));
    ...
    x70=((((-1.00000000000000)*(x34)))+(x35));
    x71=((-1.00000000000000)*(x29));
    x72=((x0)*(x71));
    x73=((x72)+(x30));
    x74=((x5)*(x70));
    x75=((x5)*(x73));
    ...
    x93=((x91)+(x92));
    x94=((x19)*(x93));
    x95=((((-1.00000000000000)*(x45)))+(x46));
    x96=((x0)*(x95));
    x97=((x47)+(x96));
    x98=((x5)*(x97));
    x99=((x51)*(x6));
    x100=((-1.00000000000000)*(x38));
    x101=((x100)*(x5));
    x102=((x44)*(x6));
    x103=((x101)+(x102)+(x99)+(x98));
    x104=((x103)*(x16));
    x105=((x104)+(x94));
    x106=((0.0133439112568960)*(x4)*(x6));
    x107=((0.320722528102358)*(x4)*(x5));
    x108=((x106)+(x107));
    x109=((x14)*(x6));
    x110=((x10)*(x5));
    x111=((x110)+(x109)+(x68));
    x112=((x111)+(((-1.00000000000000)*(x66))));
    x113=((0.0133439112568960)*(x4)*(x5));
    x114=((0.320722528102358)*(x4)*(x6));
    x115=((((-1.00000000000000)*(x114)))+(x113));
    x116=((x115)*(x16));
    x117=((0.321000000000000)*(x0));
    x118=((0.400000000000000)+(x117));
    x119=((x118)*(x19));
    x120=((0.100000000000000)+(x116)+(x119));
    x121=((x53)+(((-1.00000000000000)*(x52))));
    eerot[0]=((((x20)*(x69)))+(((x15)*(x62))));
    eerot[1]=((((x15)*(x87)))+(((x20)*(((((x6)*(((((-1.00000000000000)*(x35)))+(x34)))))+(((x6)*(((((x0)*(x29)))+(((-1.00000000000000)*(x30)))))))+(((x33)*(x5)))+(((x26)*(x5))))))));
    eerot[2]=((((x105)*(x15)))+(((x20)*(((((x6)*(((((-1.00000000000000)*(x47)))+(((x0)*(((((-1.00000000000000)*(x46)))+(x45)))))))))+(((x5)*(x51)))+(((x44)*(x5)))+(((x38)*(x6))))))));
    eetrans[0]=((-0.0500000000000000)+(((0.180000000000000)*(x15)*(x62)))+(((x120)*(x15)))+(((0.180000000000000)*(x20)*(x69)))+(((-1.00000000000000)*(x108)*(x20))));
    eerot[3]=((((x20)*(x62)))+(((x112)*(x15))));
    eerot[4]=((((x20)*(x87)))+(((x15)*(((((x5)*(((((-1.00000000000000)*(x31)))+(x32)))))+(((x5)*(((((-1.00000000000000)*(x0)*(x23)))+(x25)))))+(((x6)*(x73)))+(((x6)*(x70))))))));
    eerot[5]=((((x15)*(((((x100)*(x6)))+(((x5)*(((((x0)*(((((-1.00000000000000)*(x39)))+(x40)))))+(x43)))))+(((x6)*(x97)))+(((x5)*(x50)))))))+(((x105)*(x20))));
    eetrans[1]=((0.188000000000000)+(((x108)*(x15)))+(((0.180000000000000)*(x112)*(x15)))+(((x120)*(x20)))+(((0.180000000000000)*(x20)*(x62))));
    eerot[6]=((((x121)*(x16)))+(((x19)*(x60))));
    eerot[7]=((((x16)*(((((-1.00000000000000)*(x4)*(x82)))+(((-1.00000000000000)*(x84)))))))+(((x19)*(x78))));
    eerot[8]=((((x16)*(((((x4)*(((x89)+(((-1.00000000000000)*(x88)))))))+(((-1.00000000000000)*(x92)))))))+(((x103)*(x19))));
    eetrans[2]=((0.739680000000000)+(((x115)*(x19)))+(((0.180000000000000)*(x19)*(x60)))+(((0.180000000000000)*(x121)*(x16)))+(((-1.00000000000000)*(x118)*(x16)))+(j[0]));
}
        ...
        
        {
            ...
            if( IKabs(j4eval[0]) < 0.000001  )
            {
                ...
                IKReal evalcond[1];
                    ...
                    j4array[0]=IKatan2(((((5.76460752303423e+17)*(px)*(sj1)))+(((-5.76460752303423e+17)*(cj1)*(py)))), ((-0.985362149532710)+(((-7.78816199376947)*(j0)*(pz)))+(((3.89408099688473)*((j0)*(j0))))+(((3.89408099688473)*((pz)*(pz))))+(((3.89408099688473)*((px)*(px))))+(((-0.778816199376947)*(py)*(sj1)))+(((3.89408099688473)*((py)*(py))))+(((-0.778816199376947)*(cj1)*(px)))));
                ...
                } else
                {
                    ...
                    IKReal j4array[1], cj4array[1], sj4array[1];
                    bool j4valid[1]={false};
                    j4array[0]=IKatan2(((((-1.69547280089242e+16)*(px)*(sj1)))+(((1.69547280089242e+16)*(cj1)*(py)))), ((-0.985362149532710)+(((-7.78816199376947)*(j0)*(pz)))+(((3.89408099688473)*((j0)*(j0))))+(((3.89408099688473)*((pz)*(pz))))+(((3.89408099688473)*((px)*(px))))+(((-0.778816199376947)*(py)*(sj1)))+(((3.89408099688473)*((py)*(py))))+(((-0.778816199376947)*(cj1)*(px)))));
                    sj4array[0]=IKsin(j4array[0]);
                    cj4array[0]=IKcos(j4array[0]);
                    if( j4array[0] > IKPI )
                        j4array[0]-=IK2PI;
                ...
                } else
                {
                    ...
                    {
                        IKReal j2eval[1];
                        j2eval[0]=((((((0.0800000000000000)+(((-0.800000000000000)*(py)*(sj1)))+(((-0.800000000000000)*(cj1)*(px)))))*(((((0.0415698169996759)*(cj3)*(py)*(sj1)))+(((0.0415698169996759)*(cj1)*(cj3)*(px)))+(((0.999135601564979)*(cj1)*(px)*(sj3)))+(((-0.0999135601564980)*(sj3)))+(((0.999135601564979)*(py)*(sj1)*(sj3)))+(((-0.00415698169996759)*(cj3)))))))+(((((((0.800000000000000)*(j0)))+(((-0.800000000000000)*(pz)))))*(((((0.0415698169996759)*(cj3)*(pz)))+(((-0.999135601564979)*(j0)*(sj3)))+(((-0.0415698169996759)*(cj3)*(j0)))+(((0.999135601564979)*(pz)*(sj3))))))));
                        if( IKabs(j2eval[0]) < 0.000001  )
                        {
                            {
                                if( 1 )
                        ...
                        } else
                        {
                            ...
                            IKReal x135=((0.0415698169996759)*(cj3)*(pz));
                            IKReal x136=((0.999135601564979)*(pz)*(sj3));
                            IKReal x137=((x135)+(x136));
                            IKReal x138=((0.999135601564979)*(j0)*(sj3));
                            IKReal x139=((0.0415698169996759)*(cj3)*(j0));
                            IKReal x140=((x139)+(x138));
                            IKReal x141=((((-1.00000000000000)*(x140)))+(x137));
                            IKReal x142=x4;
                            IKReal x143=((2.00000000000000)*(j0)*(pz));
                            IKReal x144=x1;
                            IKReal x145=x0;
                            IKReal x146=x5;
                            IKReal x147=((0.200000000000000)*(cj1)*(px));
                            IKReal x148=((0.200000000000000)*(py)*(sj1));
                            IKReal x149=((0.0415698169996759)*(cj3)*(py)*(sj1));
                            IKReal x150=((0.0415698169996759)*(cj1)*(cj3)*(px));
                            IKReal x151=((0.999135601564979)*(cj1)*(px)*(sj3));
                            IKReal x152=((0.999135601564979)*(py)*(sj1)*(sj3));
                            IKReal x153=((x152)+(x151)+(x150)+(x149));
                            IKReal x154=((0.0999135601564980)*(sj3));
                            IKReal x155=((0.00415698169996759)*(cj3));
                            IKReal x156=((x155)+(x154));
                            IKReal x157=((((-1.00000000000000)*(x156)))+(x153));
                            IKReal x158=((-0.0415698169996759)*(px)*(sj1)*(sj3));
                            IKReal x159=((-0.999135601564979)*(cj1)*(cj3)*(py));
                            IKReal x160=((0.0415698169996759)*(cj1)*(py)*(sj3));
                            IKReal x161=((0.999135601564979)*(cj3)*(px)*(sj1));
                            IKReal x162=((x160)+(x161)+(x159)+(x158));
                            IKReal x163=((0.800000000000000)*(j0));
                            IKReal x164=((0.800000000000000)*(pz));
                            IKReal x165=((((-1.00000000000000)*(x164)))+(x163));
                            IKReal x166=((x134)*(x157));
                            IKReal x167=((x141)*(x165));
                            IKReal x168=((x166)+(x167));
                            IKReal x169=((IKabs(x168) != 0)?((IKReal)1/(x168)):(IKReal)1.0e30);
                            j2array[0]=IKatan2(((x169)*(((((x141)*(((0.0669590000000000)+(((-1.00000000000000)*(x143)))+(((-1.00000000000000)*(x148)))+(((-1.00000000000000)*(x147)))+(x142)+(x144)+(x145)+(x146)))))+(((x134)*(x162)))))), ((x169)*(((((x162)*(x165)))+(((-1.00000000000000)*(x157)*(((0.0669590000000000)+(((-1.00000000000000)*(x143)))+(((-1.00000000000000)*(x148)))+(((-1.00000000000000)*(x147)))+(x142)+(x144)+(x145)+(x146)))))))));
                            sj2array[0]=IKsin(j2array[0]);
                            cj2array[0]=IKcos(j2array[0]);
                            if( j2array[0] > IKPI )
                                j2array[0]-=IK2PI;
                            ...
                            
                            {
                                    ...
                                    IKReal evalcond[3];
                                        ...
                                        {
                                        {
                                            ...
                                            } else
                                            {
                                                ...
                                                IKReal j4array[1], cj4array[1], sj4array[1];
                                                bool j4valid[1]={false};
                                                j4array[0]=IKatan2(((((5.76460752303423e+17)*(px)*(sj1)))+(((-5.76460752303423e+17)*(cj1)*(py)))), ((1.79582788879571e+18)*(((IKabs(sj2) != 0)?((IKReal)1/(sj2)):(IKReal)1.0e30))*(((((-6.93889390390723e-19)*(sj2)))+(((-1.73472347597681e-18)*(pz)))+(((1.73472347597681e-18)*(j0)))+(((-0.321000000000000)*(cj2)*(((((-1.00000000000000)*(cj1)*(py)))+(((px)*(sj1)))))))))));
                                                sj4array[0]=IKsin(j4array[0]);
                                                cj4array[0]=IKcos(j4array[0]);
                                                if( j4array[0] > IKPI )
                                                    j4array[0]-=IK2PI;
                                    ...
                                    } else
                                    {
                                        ...
                                        {
                                        {
                                            ...
                                            } else
                                            {
                                                ...
                                                IKReal j4array[1], cj4array[1], sj4array[1];
                                                bool j4valid[1]={false};
                                                j4array[0]=IKatan2(((((-1.69547280089242e+16)*(px)*(sj1)))+(((1.69547280089242e+16)*(cj1)*(py)))), ((-5.28184673175209e+16)*(((IKabs(sj2) != 0)?((IKReal)1/(sj2)):(IKReal)1.0e30))*(((((2.35922392732846e-17)*(sj2)))+(((5.89805981832114e-17)*(pz)))+(((-5.89805981832114e-17)*(j0)))+(((0.321000000000000)*(cj2)*(((((-1.00000000000000)*(cj1)*(py)))+(((px)*(sj1)))))))))));
                                                sj4array[0]=IKsin(j4array[0]);
                                                cj4array[0]=IKcos(j4array[0]);
                                                if( j4array[0] > IKPI )
                                                    j4array[0]-=IK2PI;
                                ...
                                } else
                                {
                                    ...
                                    IKReal j4array[1], cj4array[1], sj4array[1];
                                    bool j4valid[1]={false};
                                    j4array[0]=IKatan2(((-1.00000000000000)*(((IKabs(((((0.0133439112568960)*(cj3)))+(((0.320722528102358)*(sj3))))) != 0)?((IKReal)1/(((((0.0133439112568960)*(cj3)))+(((0.320722528102358)*(sj3)))))):(IKReal)1.0e30))*(((((-1.00000000000000)*(cj1)*(py)))+(((px)*(sj1)))))), ((-1.24610591900312)+(((3.11526479750779)*(cj1)*(cj2)*(px)))+(((-0.311526479750779)*(cj2)))+(((3.11526479750779)*(j0)*(sj2)))+(((3.11526479750779)*(cj2)*(py)*(sj1)))+(((-3.11526479750779)*(pz)*(sj2)))));
                                    sj4array[0]=IKsin(j4array[0]);
                                    cj4array[0]=IKcos(j4array[0]);
                                    if( j4array[0] > IKPI )
                                        j4array[0]-=IK2PI;
            ...
            } else
            {
                ...
                IKReal j4array[1], cj4array[1], sj4array[1];
                bool j4valid[1]={false};
                j4array[0]=IKatan2(((-1.00000000000000)*(((IKabs(((((0.0133439112568960)*(cj3)))+(((0.320722528102358)*(sj3))))) != 0)?((IKReal)1/(((((0.0133439112568960)*(cj3)))+(((0.320722528102358)*(sj3)))))):(IKReal)1.0e30))*(((((-1.00000000000000)*(cj1)*(py)))+(((px)*(sj1)))))), ((-0.985362149532710)+(((3.89408099688473)*((py)*(py))))+(((3.89408099688473)*((j0)*(j0))))+(((3.89408099688473)*((pz)*(pz))))+(((-0.778816199376947)*(py)*(sj1)))+(((3.89408099688473)*((px)*(px))))+(((-0.778816199376947)*(cj1)*(px)))+(((-7.78816199376947)*(j0)*(pz)))));
                sj4array[0]=IKsin(j4array[0]);
                cj4array[0]=IKcos(j4array[0]);
                if( j4array[0] > IKPI )
                    j4array[0]-=IK2PI;
                ...
                {
                    IKReal j2eval[1];
                    j2eval[0]=((((-1.00000000000000)*((((((0.0133439112568960)*(sj3)*(sj4)))+(((-0.320722528102358)*(cj3)*(sj4)))))*(((((0.0133439112568960)*(sj3)*(sj4)))+(((-0.320722528102358)*(cj3)*(sj4))))))))+(((-1.00000000000000)*((((0.400000000000000)+(((0.321000000000000)*(cj4)))))*(((0.400000000000000)+(((0.321000000000000)*(cj4)))))))));
                    if( IKabs(j2eval[0]) < 0.000001  )
                    {
                        {
                            if( 1 )
                            ...
                            {
                                IKReal j2eval[1];
                                j2eval[0]=((((-1.00000000000000)*(((0.400000000000000)+(((0.321000000000000)*(cj4)))))*(((0.100000000000000)+(((-1.00000000000000)*(cj1)*(px)))+(((-1.00000000000000)*(py)*(sj1)))))))+(((-1.00000000000000)*(((pz)+(((-1.00000000000000)*(j0)))))*(((((0.0133439112568960)*(sj3)*(sj4)))+(((-0.320722528102358)*(cj3)*(sj4))))))));
                                if( IKabs(j2eval[0]) < 0.000001  )
                                {
                                    {
                                        if( 1 )
                                ...
                                } else
                                {
                                    ...
                                    IKReal j2array[1], cj2array[1], sj2array[1];
                                    bool j2valid[1]={false};
                                    IKReal x170=((0.0133439112568960)*(sj3)*(sj4));
                                    IKReal x171=((0.320722528102358)*(cj3)*(sj4));
                                    IKReal x172=((((-1.00000000000000)*(x171)))+(x170));
                                    IKReal x173=((pz)+(((-1.00000000000000)*(j0))));
                                    IKReal x174=((0.321000000000000)*(cj4));
                                    IKReal x175=((0.400000000000000)+(x174));
                                    IKReal x176=((cj1)*(px));
                                    IKReal x177=((py)*(sj1));
                                    IKReal x178=((x177)+(x176));
                                    IKReal x179=((0.100000000000000)+(((-1.00000000000000)*(x178))));
                                    IKReal x180=((x172)*(x173));
                                    IKReal x181=((x175)*(x179));
                                    IKReal x182=((x180)+(x181));
                                    IKReal x183=((-1.00000000000000)*(x182));
                                    IKReal x184=((IKabs(x183) != 0)?((IKReal)1/(x183)):(IKReal)1.0e30);
                                    j2array[0]=IKatan2(((x184)*(((((x172)*(x175)))+(((x173)*(x179)))))), ((x184)*((((x175)*(x175))+(((x173)*(((((-1.00000000000000)*(pz)))+(j0)))))))));
                                    sj2array[0]=IKsin(j2array[0]);
                                    cj2array[0]=IKcos(j2array[0]);
                                    if( j2array[0] > IKPI )
                                        j2array[0]-=IK2PI;
...
return vsolutions.size()>0;
    ...
    void rotationfunction0(std::vector<IKSolution>& vsolutions) {
        IKReal x26=((0.0415698169996759)*(cj1)*(sj2));
        IKReal x27=((0.999135601564979)*(sj1));
        IKReal x28=((((-1.00000000000000)*(x27)))+(x26));
        IKReal x29=((sj3)*(x28));
        IKReal x30=((0.0415698169996759)*(sj1));
        IKReal x31=((0.999135601564979)*(cj1)*(sj2));
        IKReal x32=((x31)+(x30));
        IKReal x33=((-1.00000000000000)*(x32));
        IKReal x34=((cj3)*(x33));
        IKReal x35=((x34)+(x29));
        IKReal x36=((sj4)*(x35));
        IKReal x37=((cj1)*(cj2)*(cj4));
        IKReal x38=((x37)+(x36));
        IKReal x39=((0.0415698169996759)*(cj2)*(sj3));
        IKReal x40=((0.999135601564979)*(cj2)*(cj3));
        IKReal x41=((((-1.00000000000000)*(x40)))+(x39));
        IKReal x42=((sj4)*(x41));
        IKReal x43=((cj4)*(sj2));
        IKReal x44=((((-1.00000000000000)*(x43)))+(x42));
        IKReal x45=((cj2)*(cj4)*(sj1));
        IKReal x46=((0.999135601564979)*(cj1));
        IKReal x47=((sj2)*(x30));
        IKReal x48=((x46)+(x47));
        IKReal x49=((sj3)*(x48));
        IKReal x50=((0.0415698169996759)*(cj1));
        IKReal x51=((sj2)*(x27));
        ...
        IKReal x59=((x58)+(x57));
        IKReal x60=((cj3)*(x48));
        IKReal x61=((x51)+(((-1.00000000000000)*(x50))));
        IKReal x62=((sj3)*(x61));
        IKReal x63=((x60)+(x62));
        IKReal x64=((0.0415698169996759)*(cj2)*(cj3));
        IKReal x65=((0.999135601564979)*(cj2)*(sj3));
        IKReal x66=((x64)+(x65));
        IKReal x67=((-1.00000000000000)*(x48));
        IKReal x68=((sj3)*(x67));
        IKReal x69=((cj3)*(x61));
        IKReal x70=((x68)+(x69));
        IKReal x71=((cj4)*(x70));
        ...
        IKReal x73=((x72)+(x71));
        IKReal x74=((((-1.00000000000000)*(x39)))+(x40));
        IKReal x75=((cj4)*(x74));
        IKReal x76=((sj2)*(sj4));
        IKReal x77=((((-1.00000000000000)*(x76)))+(x75));
        IKReal x78=((((-1.00000000000000)*(x26)))+(x27));
        IKReal x79=((sj3)*(x78));
        IKReal x80=((cj3)*(x32));
        IKReal x81=((x79)+(x80));
        IKReal x82=((cj4)*(x81));
        IKReal x83=((cj1)*(cj2)*(sj4));
        IKReal x84=((x82)+(x83));
        new_r00=((((r20)*(x44)))+(((r10)*(x56)))+(((r00)*(x38))));
        new_r01=((((r11)*(x56)))+(((r01)*(x38)))+(((r21)*(x44))));
        new_r02=((((r22)*(x44)))+(((r02)*(x38)))+(((r12)*(x56))));
        new_r10=((((r10)*(x63)))+(((r00)*(x59)))+(((r20)*(x66))));
        new_r11=((((r11)*(x63)))+(((r01)*(x59)))+(((r21)*(x66))));
        new_r12=((((r22)*(x66)))+(((r02)*(x59)))+(((r12)*(x63))));
        new_r20=((((r10)*(x73)))+(((r00)*(x84)))+(((r20)*(x77))));
        new_r21=((((r21)*(x77)))+(((r11)*(x73)))+(((r01)*(x84))));
        new_r22=((((r22)*(x77)))+(((r02)*(x84)))+(((r12)*(x73))));
        {
        IKReal j6eval;
        j6eval=new_r00;
