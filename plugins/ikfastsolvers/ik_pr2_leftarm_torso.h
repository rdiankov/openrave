...
///
/// generated 2011-01-11 17:50:42.685575
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[2]=((0.739680000000000)+(((0.180000000000000)*(x12)*(x6)*(x7)*(x9)))+(((0.180000000000000)*(x13)*(x4)*(x5)*(x6)))+(((-0.180000000000000)*(x1)*(x11)*(x4)))+(((-0.321000000000000)*(x1)*(x4)))+(((-0.180000000000000)*(x11)*(x12)*(x2)*(x5)))+(((-0.180000000000000)*(x1)*(x12)*(x13)*(x2)*(x6)))+(j[0])+(((-0.321000000000000)*(x12)*(x2)*(x5)))+(((-0.400000000000000)*(x4))));
}
...
new_pz=((-0.739680000000000)+(((-3.99680288865056e-17)*(r20)))+(pz)+(((-0.180000000000000)*(r22)))+(((-1.00000000000000)*(j0))));
