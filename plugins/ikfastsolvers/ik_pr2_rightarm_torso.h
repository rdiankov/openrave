...
///
/// generated 2010-12-07 22:00:37.912847
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x12=IKcos(j[7]);
x13=IKsin(j[7]);
eerot[0]=((((-1.00000000000000)*(x0)*(x11)*(x4)*(x7)*(x8)))+(((-1.00000000000000)*(x0)*(x11)*(x2)*(x3)*(x6)))+(((-1.00000000000000)*(x0)*(x2)*(x4)*(x5)*(x6)*(x7)))+(((x0)*(x1)*(x10)*(x2)*(x7)))+(((-1.00000000000000)*(x10)*(x2)*(x5)*(x6)*(x9)))+(((x0)*(x3)*(x5)*(x8)))+(((-1.00000000000000)*(x10)*(x11)*(x8)*(x9)))+(((-1.00000000000000)*(x1)*(x2)*(x4)*(x9))));
eerot[1]=((((-1.00000000000000)*(x0)*(x1)*(x10)*(x13)*(x7)*(x8)))+(((-1.00000000000000)*(x10)*(x11)*(x13)*(x2)*(x9)))+(((x10)*(x13)*(x5)*(x6)*(x8)*(x9)))+(((x1)*(x13)*(x4)*(x8)*(x9)))+(((x0)*(x13)*(x4)*(x5)*(x6)*(x7)*(x8)))+(((x0)*(x13)*(x2)*(x3)*(x5)))+(((x0)*(x1)*(x11)*(x12)*(x3)))+(((x1)*(x10)*(x12)*(x5)*(x9)))+(((x0)*(x10)*(x12)*(x6)*(x7)))+(((x0)*(x11)*(x13)*(x3)*(x6)*(x8)))+(((-1.00000000000000)*(x0)*(x11)*(x13)*(x2)*(x4)*(x7)))+(((-1.00000000000000)*(x12)*(x4)*(x6)*(x9)))+(((x0)*(x1)*(x12)*(x4)*(x5)*(x7))));
eerot[2]=((((-1.00000000000000)*(x0)*(x1)*(x10)*(x12)*(x7)*(x8)))+(((-1.00000000000000)*(x0)*(x1)*(x13)*(x4)*(x5)*(x7)))+(((x0)*(x12)*(x4)*(x5)*(x6)*(x7)*(x8)))+(((-1.00000000000000)*(x0)*(x10)*(x13)*(x6)*(x7)))+(((-1.00000000000000)*(x10)*(x11)*(x12)*(x2)*(x9)))+(((-1.00000000000000)*(x0)*(x11)*(x12)*(x2)*(x4)*(x7)))+(((-1.00000000000000)*(x1)*(x10)*(x13)*(x5)*(x9)))+(((x13)*(x4)*(x6)*(x9)))+(((x10)*(x12)*(x5)*(x6)*(x8)*(x9)))+(((x0)*(x12)*(x2)*(x3)*(x5)))+(((x0)*(x11)*(x12)*(x3)*(x6)*(x8)))+(((x1)*(x12)*(x4)*(x8)*(x9)))+(((-1.00000000000000)*(x0)*(x1)*(x11)*(x13)*(x3))));
eetrans[0]=((-0.0500000000000000)+(((-0.180000000000000)*(x10)*(x2)*(x5)*(x6)*(x9)))+(((0.400000000000000)*(x0)*(x3)))+(((-0.180000000000000)*(x10)*(x11)*(x8)*(x9)))+(((-0.180000000000000)*(x0)*(x11)*(x4)*(x7)*(x8)))+(((0.100000000000000)*(x0)))+(((-0.180000000000000)*(x0)*(x2)*(x4)*(x5)*(x6)*(x7)))+(((0.180000000000000)*(x0)*(x1)*(x10)*(x2)*(x7)))+(((-0.321000000000000)*(x10)*(x11)*(x9)))+(((-0.180000000000000)*(x0)*(x11)*(x2)*(x3)*(x6)))+(((-0.321000000000000)*(x0)*(x11)*(x4)*(x7)))+(((0.321000000000000)*(x0)*(x3)*(x5)))+(((0.180000000000000)*(x0)*(x3)*(x5)*(x8)))+(((-0.180000000000000)*(x1)*(x2)*(x4)*(x9))));
eerot[3]=((((x0)*(x10)*(x2)*(x5)*(x6)))+(((-1.00000000000000)*(x11)*(x2)*(x3)*(x6)*(x9)))+(((x0)*(x1)*(x2)*(x4)))+(((-1.00000000000000)*(x2)*(x4)*(x5)*(x6)*(x7)*(x9)))+(((x1)*(x10)*(x2)*(x7)*(x9)))+(((x0)*(x10)*(x11)*(x8)))+(((-1.00000000000000)*(x11)*(x4)*(x7)*(x8)*(x9)))+(((x3)*(x5)*(x8)*(x9))));
eerot[4]=((((x0)*(x12)*(x4)*(x6)))+(((x11)*(x13)*(x3)*(x6)*(x8)*(x9)))+(((x10)*(x12)*(x6)*(x7)*(x9)))+(((x0)*(x10)*(x11)*(x13)*(x2)))+(((-1.00000000000000)*(x0)*(x1)*(x10)*(x12)*(x5)))+(((-1.00000000000000)*(x1)*(x10)*(x13)*(x7)*(x8)*(x9)))+(((-1.00000000000000)*(x0)*(x10)*(x13)*(x5)*(x6)*(x8)))+(((x13)*(x2)*(x3)*(x5)*(x9)))+(((x13)*(x4)*(x5)*(x6)*(x7)*(x8)*(x9)))+(((-1.00000000000000)*(x11)*(x13)*(x2)*(x4)*(x7)*(x9)))+(((-1.00000000000000)*(x0)*(x1)*(x13)*(x4)*(x8)))+(((x1)*(x11)*(x12)*(x3)*(x9)))+(((x1)*(x12)*(x4)*(x5)*(x7)*(x9))));
eerot[5]=((((-1.00000000000000)*(x0)*(x10)*(x12)*(x5)*(x6)*(x8)))+(((-1.00000000000000)*(x1)*(x13)*(x4)*(x5)*(x7)*(x9)))+(((-1.00000000000000)*(x0)*(x13)*(x4)*(x6)))+(((-1.00000000000000)*(x1)*(x11)*(x13)*(x3)*(x9)))+(((-1.00000000000000)*(x11)*(x12)*(x2)*(x4)*(x7)*(x9)))+(((-1.00000000000000)*(x1)*(x10)*(x12)*(x7)*(x8)*(x9)))+(((x12)*(x4)*(x5)*(x6)*(x7)*(x8)*(x9)))+(((x12)*(x2)*(x3)*(x5)*(x9)))+(((x0)*(x10)*(x11)*(x12)*(x2)))+(((x11)*(x12)*(x3)*(x6)*(x8)*(x9)))+(((x0)*(x1)*(x10)*(x13)*(x5)))+(((-1.00000000000000)*(x0)*(x1)*(x12)*(x4)*(x8)))+(((-1.00000000000000)*(x10)*(x13)*(x6)*(x7)*(x9))));
eetrans[1]=((-0.188000000000000)+(((0.180000000000000)*(x1)*(x10)*(x2)*(x7)*(x9)))+(((-0.321000000000000)*(x11)*(x4)*(x7)*(x9)))+(((0.180000000000000)*(x3)*(x5)*(x8)*(x9)))+(((0.400000000000000)*(x3)*(x9)))+(((0.321000000000000)*(x3)*(x5)*(x9)))+(((0.180000000000000)*(x0)*(x1)*(x2)*(x4)))+(((0.100000000000000)*(x9)))+(((-0.180000000000000)*(x11)*(x4)*(x7)*(x8)*(x9)))+(((-0.180000000000000)*(x2)*(x4)*(x5)*(x6)*(x7)*(x9)))+(((0.180000000000000)*(x0)*(x10)*(x2)*(x5)*(x6)))+(((-0.180000000000000)*(x11)*(x2)*(x3)*(x6)*(x9)))+(((0.321000000000000)*(x0)*(x10)*(x11)))+(((0.180000000000000)*(x0)*(x10)*(x11)*(x8))));
eerot[6]=((((-1.00000000000000)*(x5)*(x7)*(x8)))+(((x1)*(x10)*(x2)*(x3)))+(((x11)*(x2)*(x6)*(x7)))+(((-1.00000000000000)*(x2)*(x3)*(x4)*(x5)*(x6)))+(((-1.00000000000000)*(x11)*(x3)*(x4)*(x8))));
eerot[7]=((((-1.00000000000000)*(x13)*(x2)*(x5)*(x7)))+(((x1)*(x12)*(x3)*(x4)*(x5)))+(((-1.00000000000000)*(x1)*(x11)*(x12)*(x7)))+(((-1.00000000000000)*(x11)*(x13)*(x6)*(x7)*(x8)))+(((-1.00000000000000)*(x11)*(x13)*(x2)*(x3)*(x4)))+(((x10)*(x12)*(x3)*(x6)))+(((x13)*(x3)*(x4)*(x5)*(x6)*(x8)))+(((-1.00000000000000)*(x1)*(x10)*(x13)*(x3)*(x8))));
eerot[8]=((((-1.00000000000000)*(x12)*(x2)*(x5)*(x7)))+(((-1.00000000000000)*(x1)*(x13)*(x3)*(x4)*(x5)))+(((-1.00000000000000)*(x1)*(x10)*(x12)*(x3)*(x8)))+(((-1.00000000000000)*(x11)*(x12)*(x2)*(x3)*(x4)))+(((x12)*(x3)*(x4)*(x5)*(x6)*(x8)))+(((-1.00000000000000)*(x11)*(x12)*(x6)*(x7)*(x8)))+(((-1.00000000000000)*(x10)*(x13)*(x3)*(x6)))+(((x1)*(x11)*(x13)*(x7))));
eetrans[2]=((0.739680000000000)+(((-0.180000000000000)*(x2)*(x3)*(x4)*(x5)*(x6)))+(((-0.180000000000000)*(x11)*(x3)*(x4)*(x8)))+(((-0.180000000000000)*(x5)*(x7)*(x8)))+(((0.180000000000000)*(x1)*(x10)*(x2)*(x3)))+(((0.180000000000000)*(x11)*(x2)*(x6)*(x7)))+(((-0.321000000000000)*(x11)*(x3)*(x4)))+(j[0])+(((-0.400000000000000)*(x7)))+(((-0.321000000000000)*(x5)*(x7))));
}
...
IKFAST_API const char* getKinematicsHash() { return "b0862e5b00c7cc6ee2b0fa5304ee7a80"; }
