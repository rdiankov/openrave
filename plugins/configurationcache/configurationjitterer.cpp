...
public:
    ...
    ConfigurationJitterer(const EnvironmentBasePtr& penv, std::istream& is) : SpaceSamplerBase(penv)
    {
...
SpaceSamplerBasePtr CreateConfigurationJitterer(const EnvironmentBasePtr& penv, std::istream& sinput)
{
