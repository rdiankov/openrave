...
void QtOSGViewer::_InitGUI(bool bCreateStatusBar, bool bCreateMenu)
{
    ...
    _posgWidget = new ViewerWidget(GetEnv(), _userdatakey, std::bind(&QtOSGViewer::_HandleOSGKeyDown, this, std::placeholders::_1), GetEnv()->GetUnit().second);
...
{
  _PostToGUIThread(std::bind((void (QtOSGViewer::*)(int, int))&QtOSGViewer::resize, this, w, h));
}
void QtOSGViewer::Move(int x, int y)
{
  _PostToGUIThread(std::bind((void (QtOSGViewer::*)(int, int))&QtOSGViewer::move, this, x, y));
}
