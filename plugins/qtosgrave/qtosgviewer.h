...
public:
    ...
    virtual bool GetCameraImage(std::vector<uint8_t>& color, int width, int height, const RaveTransform<float>& t, const SensorBase::CameraIntrinsics& KK, std::vector<float>* depth = nullptr);
