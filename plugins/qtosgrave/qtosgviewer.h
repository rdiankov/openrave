...
public:
    ...
    virtual GraphHandlePtr drawlabel(const std::string& label, const RaveVector<float>& voffset);
...
public:
    ...
    virtual void _DrawLabel(OSGSwitchPtr handle, const std::string& label, const RaveVector<float>& voffset);
