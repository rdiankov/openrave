...
public:
    ...
    virtual void _ToggleCropMarginVisible(const std::string& name);
    virtual void _ToggleCropEmptyMarginVisible(const std::string& name);
    ...
    bool _ToggleCropMarginVisibleCommand(ostream& sout, istream& sinput);
    bool _ToggleCropEmptyMarginVisibleCommand(ostream& sout, istream& sinput);
