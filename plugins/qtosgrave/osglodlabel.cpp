...
OSGLODLabel::OSGLODLabel(const std::string& label, const RaveVector<float>& color, float scale, osg::ref_ptr<osgText::Font> font) : osg::LOD() {
    ...
    */
    ...
    text->setText(label);
    text->setCharacterSize(0.05 * scale);
