...
";
    ...
    virtual bool InitPlan(RobotBasePtr probot, PlannerParametersConstPtr params)
    {
        ...
        std::shared_ptr<WorkspaceTrajectoryParameters> parameters(new WorkspaceTrajectoryParameters(GetEnv()));
    ...
    virtual PlannerStatus PlanPath(TrajectoryBasePtr poutputtraj)
    {
        ...
        UserDataPtr filterhandle = _manip->GetIkSolver()->RegisterCustomFilter(0,std::bind(&WorkspaceTrajectoryTracker::_ValidateSolution,this,std::placeholders::_1,std::placeholders::_2,std::placeholders::_3));
...
protected:
    ...
    std::shared_ptr<WorkspaceTrajectoryParameters> _parameters;
