...
public:
    ...
    {
public:
        CubicGroupInfo(int degree, const ConfigurationSpecification::Group& gPos, const ConfigurationSpecification::Group& gVel, const ConfigurationSpecification::Group& gAccel) : GroupInfo(degree, gPos, gVel, gAccel)
        {
        }
