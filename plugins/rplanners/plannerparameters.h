...
{
public:
    TrajectoryTimingParameters() : _interpolation("linear"), _pointtolerance(0.2), _hastimestamps(false), _outputaccelchanges(true), _fToolAccelerationLimit(0), _bProcessing(false) {
