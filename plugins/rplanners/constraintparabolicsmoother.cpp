...
protected:
    ...
    //OPENRAVE_SHARED_PTR<ConfigurationSpecification::SetConfigurationStateFn> _setstatefn, _setvelstatefn;
    //OPENRAVE_SHARED_PTR<ConfigurationSpecification::GetConfigurationStateFn> _getstatefn, _getvelstatefn;
