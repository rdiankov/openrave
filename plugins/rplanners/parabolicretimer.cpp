...
protected:
    ...
    bool _WriteJointValues(GroupInfoConstPtr inforaw, std::vector<dReal>::const_iterator itorgdiff, std::vector<dReal>::const_iterator itdataprev, std::vector<dReal>::iterator itdata) {
        ...
        if( _parameters->_outputaccelchanges ) {
            ...
            bool success = ParabolicRamp::SolveAccelBoundedND(_v0pos, _v0vel, _v1pos, _v1vel, deltatime, info->_vConfigAccelerationLimit, info->_vConfigVelocityLimit, info->_vConfigLowerLimit,info->_vConfigUpperLimit, _ramps, _parameters->_multidofinterp);
            if( !success ) {
#ifdef _DEBUG
                if( IS_DEBUGLEVEL(Level_Verbose) ) {
                    // for debugging
                    success = ParabolicRamp::SolveAccelBoundedND(_v0pos, _v0vel, _v1pos, _v1vel, deltatime, info->_vConfigAccelerationLimit, info->_vConfigVelocityLimit, info->_vConfigLowerLimit,info->_vConfigUpperLimit, _ramps, _parameters->_multidofinterp);
                }
#endif
    ...
    bool _WriteIk(GroupInfoConstPtr inforaw, IkParameterizationType iktype, std::vector<dReal>::const_iterator itorgdiff, std::vector<dReal>::const_iterator itdataprev, std::vector<dReal>::iterator itdata) {
        ...
        if( _parameters->_outputaccelchanges ) {
            ...
            bool success = ParabolicRamp::SolveAccelBoundedND(_v0pos, _v0vel, _v1pos, _v1vel, deltatime, vmaxaccel, vmaxvel, vlower, vupper, _ramps,_parameters->_multidofinterp);
            if( !success ) {
#ifdef _DEBUG
                if( IS_DEBUGLEVEL(Level_Verbose) ) {
                    success = ParabolicRamp::SolveAccelBoundedND(_v0pos, _v0vel, _v1pos, _v1vel, deltatime, vmaxaccel, vmaxvel, vlower, vupper, _ramps,_parameters->_multidofinterp);
                }
#endif
                return false;
            }
