...
public:
    ...
    typedef tools::shared_ptr<ParabolicGroupInfo> ParabolicGroupInfoPtr;
    typedef tools::shared_ptr<ParabolicGroupInfo const> ParabolicGroupInfoConstPtr;
...
protected:
    ...
    void ResetCachedGroupInfo(GroupInfoPtr g)
    {
        ...
        ParabolicGroupInfoPtr parabolicgroup = tools::dynamic_pointer_cast<ParabolicGroupInfo>(g);
    ...
    bool _WriteJointValues(GroupInfoConstPtr inforaw, std::vector<dReal>::const_iterator itorgdiff, std::vector<dReal>::const_iterator itdataprev, std::vector<dReal>::iterator itdata) {
        ParabolicGroupInfoConstPtr info = tools::dynamic_pointer_cast<ParabolicGroupInfo const>(inforaw);
    ...
    void _WriteTrajectory(TrajectoryBasePtr ptraj, const ConfigurationSpecification& newspec, const std::vector<dReal>& data) {
        ...
        if( _parameters->_outputaccelchanges ) {
            ...
            FOREACH(it,_listgroupinfo) {
                listtrajectories.push_back(tools::dynamic_pointer_cast<ParabolicGroupInfo>(*it)->ptraj);
            }
