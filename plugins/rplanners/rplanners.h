...
////////////////////////////////////////////////////////////////////////////////////////////////////
struct SimpleNodeOld
{
    SimpleNodeOld(int parent, const vector<dReal>& q) : parent(parent), q(q) {
    }
    int parent;
    vector<dReal> q; // the configuration immediately follows the struct
};

class SpatialTreeBaseOld
{
public:
...
class SpatialTreeOld : public SpatialTreeBaseOld
{
public:
    SpatialTreeOld(int fromgoal) {
        _fromgoal = fromgoal;
        _fStepLength = 0.04f;
        _dof = 0;
        _fBestDist = 0;
...
BOOST_TYPEOF_REGISTER_TYPE(SimpleNodeOld)
BOOST_TYPEOF_REGISTER_TYPE(SpatialTreeOld)
#endif
