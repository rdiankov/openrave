...
# set(CPACK_DEBIAN_RELEASE_VERSION "0")
##
...
set(DEBIAN_SOURCE_ORIG_DIR "${CMAKE_BINARY_DIR}/Debian/${CPACK_DEBIAN_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${CPACK_DEBIAN_RELEASE_VERSION}")
...
foreach(RELEASE ${CPACK_DEBIAN_DISTRIBUTION_RELEASES})
  ...
  add_custom_command(OUTPUT "${SOURCE_CHANGES_FILE}" COMMAND ${DEBUILD_EXECUTABLE} -S WORKING_DIRECTORY ${DEBIAN_SOURCE_DIR})
